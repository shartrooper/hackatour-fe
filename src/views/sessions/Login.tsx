    ...
    return (
        <main className='w-full flex bg-white'>
            <div className='relative flex-1 hidden items-center justify-center min-h-screen bg-gray-900 lg:flex'>
                <img src={bgRegister} className='absolute inset-0 z-0 object-cover w-full h-full' />
                <div>
                    <div className='relative z-10 w-full max-w-md bg-neptune-950 p-10 rounded-lg'>
                        <img className='bg-white rounded-lg' src={logo2} width={150} />
                        <div className='mt-5 space-y-3'>
                            <h3 className='text-white text-3xl font-bold'>
                                Bienvenido nuevamente viajero!
                            </h3>
                            <p className='text-gray-300'>
                                Inicia sesión aquí mismo y empezá a disfrutar de la mejor
                                experiencia de viaje junto con nosotros! Vacaciones, aquí vamos! 🚀
                            </p>
                        ...
                        <form onSubmit={(e) => e.preventDefault()} className='space-y-5'>
                            <div>
                                ...
                                <input
                                    type='email'
                                    required
                                    className='w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-neptune-600 shadow-sm rounded-lg'
                                />
                            </div>
                            <div>
                            ...
                            <button className='w-full px-4 py-2 text-white font-medium bg-neptune-600 hover:bg-neptune-500 active:bg-neptune-600 rounded-lg duration-150'>
                                Sign in
                            </button>
                        </form>
                    </div>
                    <div className='text-center'>
                        <a href='javascript:void(0)' className='hover:text-neptune-600'>
