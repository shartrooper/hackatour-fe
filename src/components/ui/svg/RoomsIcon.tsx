...
const RoomsIcon: React.FC<RoomsIconProps> = ({ className }) => (
    <svg
        ...
        <g id='SVGRepo_iconCarrier'>
            <path d='M352.7 103m-32 0a32 32 0 1 0 64 0 32 32 0 1 0-64 0Z' fill='#FFEB4D'></path>
            <path d='M807.7 951h-449V192L643.8 87l163.9 105z' fill='#F7D4FF'></path>
            <path d='M643.7 951h-285V192l285-105z' fill='#FFE0B6'></path>
            <path d='M523.7 951.5h-314v-531l199-74 115 74z' fill='#DAE5FF'></path>
            <path d='M408.4 951.5H209.7V420.4l199-73.9z' fill='#FFEB4D'></path>
            <path
